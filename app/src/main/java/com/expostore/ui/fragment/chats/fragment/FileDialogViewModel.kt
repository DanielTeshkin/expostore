...
@HiltViewModel
class FileDialogViewModel@Inject constructor(private val chatRepository: ChatRepository) : BaseViewModel() {
    ...
    fun saveFile(multipartBody: MultipartBody.Part, name: RequestBody){
        chatRepository.saveFile(multipartBody,name).handleResult(_saveFile)
