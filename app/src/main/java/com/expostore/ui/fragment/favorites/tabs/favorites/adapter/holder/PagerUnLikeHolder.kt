...
class PagerUnLikeHolder(binding: DetailProductImageItemBinding, context: Context,
                         onClick: OnClickFavoriteProductListener,
                        id:String
    ):BasePagerHolder(binding,context,onClick, id) {
    override fun stateLike() {
        binding.ibDetailProductLike.isChecked=false
    }
