...
class TenderCreateFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.llTenderCreateCategory.setOnClickListener {
            tenderCreateViewModel.getProductCategory(it)
        }

        binding.btnSave.setOnClickListener {
            tenderCreateViewModel.createTender(it)
        }
    ...
    private fun saveImage(image: String) {
        ...
        serverApi.saveImage("Bearer $token", requestData)
            .enqueue(object : Callback<SaveImageResponseData> {
